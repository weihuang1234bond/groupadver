...
<script language="JavaScript" type="text/javascript">
 $('#transurl').on('click', function(option) { 
	...
	var y_url = '<?php echo getdomain($p['linkurl'])?>';
	var tourl = $("#tourl").val();
	...
	var adurl = "<?php echo $GLOBALS['C_ZYIIS']['jump_url'].WEB_URL?>c.php?u=<?php echo $_SESSION ['affiliate'] ["uid"]?>&c=a&p=<?php echo $p['planid']?>&t=";
