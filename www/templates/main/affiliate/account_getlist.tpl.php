    ...
    <form action="<?php echo url("affiliate/account.edit_post")?>" method="POST" class="form-horizontal editAccount" id="form_b" >
      <div class="box-content">
        ...
        <div class="control-group">
          ...
          <div class="controls">
            <input type="text" name="tel" id="tel" class="input-27 ed_input" value="<?php echo $u['tel']?>">
          </div>
        </div>
        <div class="control-group">
          <label for="textfield" class="control-label">身份证号码</label>
          <div class="controls">
            <input type="text" name="idcard" id="idcard" class="input-27 ed_input" value="<?php echo $u['idcard']?>">
          </div>
        </div>
        <div class="box-title" style="margin-bottom: 40px;">
        ...
        <div class="control-group">
          <label for="textfield" class="control-label">收款银行</label>
          <div class="controls">
        ...
        <div class="control-group">
          <label for="textfield" class="control-label">开户地分行</label>
          <div class="controls">
            <input type="text" name="bankbranch" id="bankbranch" class="input-27" value="<?php echo $u['bankbranch']?>">
          </div>
        </div>
        <div class="control-group">
          <label for="textfield" class="control-label">银行账号</label>
          <div class="controls">
            <input type="text" name="bankaccount" id="bankaccount" class="input-27" value="<?php echo $u['bankaccount']?>">
          </div>
        </div>
        <div class="control-group">
          <label for="textfield" class="control-label">收款人</label>
          <div class="controls">
            <input type="text" name="accountname" id="accountname" class="input-27" value="<?php echo $u['accountname']?>">
          </div>
        </div>
